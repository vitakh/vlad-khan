...
const Theory6 = () => {
  return (
    <div>
      ...
      <p>где <span className="fst-italic">n</span> – объем совокупности (выборки), число вариантов; <InlineMath math="{х_1 \cdot х_2 \cdot х_3 \cdot _\dots \cdot x_n}"/> – значения вариант. При этом <InlineMath math="{х_1  > 0}"/>. При наличии нулевого показателя вместо среднего геометрического вычисляется приближенное среднее арифметическое.</p>
